...
contract WorkCD {
	...
	function createCompany(string calldata _name) external returns (Company memory) {
		CompanyContract comContract = new CompanyContract(_host, _cfa, _acceptedToken, msg.sender);
